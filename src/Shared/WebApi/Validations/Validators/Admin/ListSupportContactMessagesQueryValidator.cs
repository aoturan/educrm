...
public sealed class ListSupportContactMessagesQueryValidator : AbstractValidator<ListSupportContactMessagesQuery>
{
    public ListSupportContactMessagesQueryValidator()
    {
        RuleFor(x => x.Page)
